...
export const ContainerCoverStyle = styled.section<ContainerCoverStyleProps>`
    ...
    > section {
        background-color: ${({opacity}) => opacity ? `rgba(255, 255, 255, ${opacity});` : 'rgba(255, 255, 255, 0.25);' };
        > * {
            margin-bottom: ${({childrenMarginBottom}) => childrenMarginBottom ? childrenMarginBottom : 0 };
        }
