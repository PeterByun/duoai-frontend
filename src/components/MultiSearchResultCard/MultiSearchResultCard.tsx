...
const MultiSearchResultCard = (props: MultiSearchResultCardProps) => {
    ...
    return (
        <Container flexDirection='column' justify='flex-start' width='16rem' gap='1rem' padding='1rem' margin='0'>
                ...
                <StyledFlexBox flexDirection='row' border='0px 0px 1px 0px solid black' padding="0 1rem">
                ...
                { props.summonerSearchResult.streakResult > 0 && <StyledFlexBox flexDirection='row'>
                        ...
                        <StyledFlexBox flexDirection='column' align='flex-start' width='100%'>
                            {
                                props.summonerSearchResult.playedGameInfoList.map((gameRecord) => {
                                    return (
                                        <StyledFlexBox key={gameRecord.date} flexDirection='row' width='100%'>
                                            <ImgChampion
                                                width="1.5rem"
                                                height="1.5rem"
                                                borderRadius="100%"
